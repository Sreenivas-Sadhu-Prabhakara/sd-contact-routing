package com.bank.bian.contactrouting.model;
...
/**
 * The BIAN control record for this service domain: "Contact Routing Record Procedure".
 *
 ...
 * to its asset type (Contact Routing Record). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Contact Routing Record Procedure";
